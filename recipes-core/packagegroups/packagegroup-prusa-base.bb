...
RDEPENDS_${PN} = "\
    cmake gdb rsync tar tmux readline grep lrzsz htop less mc man \
    ...
    iputils-ping bash-completion bash-completion-extra \
    ...
    diffutils elfutils file i2c-tools lsof lz4 m4 meson minicom  \
