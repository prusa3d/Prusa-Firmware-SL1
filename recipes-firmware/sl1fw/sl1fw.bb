...
file://fb.modes \
"
SRCREV_pn-${PN} = "f61f0f0b325a2821890b239fa472393f2ef63137"


PACKAGES = "${PN}"

RDEPENDS_${PN} += "python rsync bash nginx python-websocket-server python-pygame python-pyserial python-pyroute2 python-numpy python-six python-numpy python-jinja2 python-gpio avahi-daemon avahi-restarter python-lazy-import api-keygen udiskie web-config avrdude python-pydbus python-misc python-pygobject python-systemd socat"
